...
2. Filter TechCrunch's "Startups" category feed to exclude funding-
   ...
   appoints new CEO"). These are real, on-topic startup news, but they
   don't fit the report's per-item template - an already-funded company
   doesn't have a meaningful "MVP cost" or "30-Day MVP Plan". Keeps
   genuine product-launch style articles.

Usage: put this file in the ROOT of your startup-scout-ai_repo folder
(next to main.py) and run:

    python apply_persistence_fix_v2.py
...
# END OF FILE MARKER persistence-fix-v2
